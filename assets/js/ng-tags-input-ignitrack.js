    ...
    return {
        ...
        link: function(scope, element, attrs, tagsInputCtrl) {
            ...
            scope.$assignTag = function() {
                scope.data.required =  scope.data.required == 1 ? 0 : 1;
            };
...
tagsInput.run(["$templateCache", function($templateCache) {
  ...
  $templateCache.put('ngTagsInput/tag-item.html',
    "<input type=\"checkbox\" ng-checked=\"data.required==1\"  ng-click=\"$assignTag()\"> <span ng-bind=\"$getDisplayText()\"></span> <a class=\"remove-button\" ng-click=\"$removeTag()\" ng-bind=\"::$$removeTagSymbol\"></a>"
  );
